...
./uploadFileToSweagle.sh WebApp,Client Client-TST.json'''
        ...
        stage('Upload') {
          steps {
            SWEAGLEUpload(actionName: 'UploadData', fileLocation: '/Users/boondock/.jenkins/workspace/SimpleConfigPipe_master/Client-TST.json', format: 'JSON', nodePath: 'Testing', description: 'Upload', showResults: true, markFailed: true)
          }
        }
      }
    }
